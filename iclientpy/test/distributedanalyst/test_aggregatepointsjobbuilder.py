...
class AggregatePointsJobBuilderTest(TestCase):
    def test(self):
        ...
        builder.prepare_summarymesh.mesh_sieze_units.Kilometer.selected()
        ...
        builder.prepare_summaryregion.available_region_datasets.s_processing_newyorkZone_R.selected()
