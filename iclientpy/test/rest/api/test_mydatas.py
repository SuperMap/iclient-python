...
class MyDatasTestCase(AbstractRESTTestCase):
    ...
    def test_datas(self):
        ...
        self.check_api(MyDatas.get_my_datas, self.baseuri + "/web/mycontent/datas.json", HttpMethod.GET,
                       httpretty.Response(body=get_body, status=201))
        entity = PostMyDatasItem()
        entity.type = DataItemType.JSON
        entity.fileName = 'test.json'
        self.check_api(MyDatas.post_my_datas, self.baseuri + "/web/mycontent/datas.json", HttpMethod.POST,
                       httpretty.Response(
    ...
    def test_data(self):
        ...
        self.check_api(MyDatas.get_my_data, self.baseuri + "/web/mycontent/datas/18220636.json", HttpMethod.GET,
        ...
        self.check_api(MyDatas.put_my_data, self.baseuri + "/web/mycontent/datas/18220636.json", HttpMethod.PUT,
                       httpretty.Response(body='{"succeed":true,"newResourceID":"1"}', status=201), data_id=data_id,
                       entity=entity)
        self.check_api(MyDatas.delete_my_data, self.baseuri + "/web/mycontent/datas/18220636.json", HttpMethod.DELETE,
                       httpretty.Response(body='{"succeed":true}', status=201), data_id=data_id)
        with open('./World.zip', 'rb') as fileb:
            self.check_api(MyDatas.upload_my_data, self.baseuri + "/web/mycontent/datas/18220636/upload.json",
                           HttpMethod.POST,
                           httpretty.Response(
