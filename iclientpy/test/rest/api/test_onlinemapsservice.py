...
from iclientpy.rest.api.onlinemapsservice import OnlineMapsService
from iclientpy.rest.api.model import *


class OnlineMapsServiceTestCase(AbstractRESTTestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_maps(self):
        ...
        self.check_api(OnlineMapsService.get_maps, self.baseuri + "/web/maps.json", HttpMethod.GET,
        ...
        self.check_api(OnlineMapsService.post_maps, self.baseuri + "/web/maps.json", HttpMethod.POST,
                       httpretty.Response(
                           body='{"succeed":true,"newResourceID":"24","newResourceLocation":"http://localhost:8090/iportal/web/maps/24"}',
                           status=201), entity=entity)
        self.check_api(OnlineMapsService.delete_maps, self.baseuri + "/web/maps.json", HttpMethod.DELETE,
    ...
    def test_map(self):
        ...
        self.check_api(OnlineMapsService.get_map, self.baseuri + "/web/maps/283390367.json", HttpMethod.GET,
                       httpretty.Response(body=get_body, status=201), map_id=map_id)

    def test_map_sharesetting(self):
        entity = OnlineMapShareSetting()
        entity.ids = ['1']
        self.check_api(OnlineMapsService.put_map_sharesetting, self.baseuri + "/web/maps/sharesetting.json",
                       HttpMethod.PUT, httpretty.Response(body='{ "succeed": true}', status=201), entity=entity)
