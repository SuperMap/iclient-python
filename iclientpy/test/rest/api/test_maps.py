...
class MapsServiceTestCase(AbstractRESTTestCase):
    ...
    def test_map_sharesetting(self):
        map_id = '283390367'
        self.check_api(MapsService.get_map_sharesetting, self.baseuri + "/web/maps/283390367/sharesetting.json",
                       HttpMethod.GET,
                       httpretty.Response(
                           body='[{"aliasName":"GUEST","entityId":null,"entityName":"GUEST","entityType":"USER","permissionType":"READ"},{"aliasName":"admin","entityId":null,"entityName":"admin","entityType":"USER","permissionType":"DELETE"}]',
                           status=201), map_id=map_id)
        entity = MapShareSetting()
        entity.permissionType = PermissionType.READWRITE
        entity.entityType = EntityType.USER
        entity.entityName = 'GUEST'
        entity.aliasName = 'GUEST'
        self.check_api(MapsService.put_map_sharesetting, self.baseuri + "/web/maps/283390367/sharesetting.json",
                       HttpMethod.PUT, httpretty.Response(body='{ "succeed": true}', status=201), map_id=map_id,
                       entity=[entity])
