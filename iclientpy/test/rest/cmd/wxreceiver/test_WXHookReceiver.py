...
class WXHookReceiverTest(TestCase):
    ...
    def setUp(self):
        ...
        _crypt_kls = MagicMock(return_value=self._crypt)
        self._receiver = WXHookReceiver('token','aeskey','corpid', self._msg_fun, _crypt_kls)
        _crypt_kls.assert_called_with('token','aeskey','corpid')
    ...
    def test_get_success(self):
        ...
        self._crypt.VerifyURL = MagicMock(return_value=(0,'abc'))
