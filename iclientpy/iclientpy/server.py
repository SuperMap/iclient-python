...
class Server:
    ...
    def __init__(self, base_url: str, username: str = None, passwd: str = None, token: str = None, proxy: str = None, api_factory_clz = APIFactory):
        ...
        if bigdata_services[ServiceComponentType.datacatalog] is not None and bigdata_services[ServiceComponentType.distributedanalysis] is not None:
