...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'iclientpy', 'static', 'extension.js'),
        os.path.join(here, 'iclientpy', 'static', 'index.js')
    ]
...
setup_args = {
    ...
    'description': 'iclient for jupyter',
    'long_description': LONG_DESCRIPTION,
    'include_package_data': True,
    'data_files': [
        ('share/jupyter/nbextensions/iclientpy', [
            'iclientpy/static/extension.js',
            'iclientpy/static/index.js',
            'iclientpy/static/index.js.map',
        ] + glob('iclientpy/static/*.png') + glob('iclientpy/static/*.svg') + glob('iclientpy/jupyter/chinageojson.json')),
    ],
    'install_requires': [
        'ipywidgets>=7.0.0',
        'ipyleaflet>=0.5.1',
